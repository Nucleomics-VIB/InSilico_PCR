...
* the results of using other databases for the MetONTIIME classification are reported in a case study in **[Metontiime_with_other_DBs.pdf](results/Metontiime_with_other_DBs.pdf)**.
